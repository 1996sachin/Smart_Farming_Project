...
if(!isset($_SESSION['forgot_password_email']) || $_SESSION['forgot_password_type'] != 'admin'){
    ob_end_clean();
      ...
      <div class="row">
        <div class="col-md-6 mx-auto">
          <div class="card card-body bg-gradient-warning">
            ...
            if ($DEV_MODE && (isset($_GET['otp']) || isset($_SESSION['forgot_password_otp']))): 
                $display_otp = isset($_GET['otp']) ? $_GET['otp'] : (isset($_SESSION['forgot_password_otp']) ? $_SESSION['forgot_password_otp'] : '');
            ?>
            <div class="alert alert-info alert-dismissible fade show" role="alert">
              <strong>🔧 Development Mode:</strong> Your OTP is: <strong style="font-size: 1.5em; color: #28a745;"><?php echo htmlspecialchars($display_otp); ?></strong>
            ...
            <form method="POST" action="aforgot_check_otp.php" id="otpForm">
              ...
              <div class="text-center mt-3">
                <a href="aforgot_password.php" class="text-primary">Resend OTP</a> | 
