...
if(!isset($_SESSION['forgot_password_email']) || !isset($_SESSION['forgot_password_verified']) || $_SESSION['forgot_password_type'] != 'farmer'){
    ob_end_clean();
...
if(isset($_POST['reset_password'])){
    ...
    if($password !== $confirm_password){
        ...
        $stmt = mysqli_prepare($conn, "UPDATE farmerlogin SET password = ?, otp = 0 WHERE email = ?");
        if($stmt){
            ...
            if(mysqli_stmt_execute($stmt)){
                ...
                ob_end_clean();
                header("location: flogin.php?success=" . urlencode("Password reset successfully! Please login with your new password."));
                exit;
            } else {
