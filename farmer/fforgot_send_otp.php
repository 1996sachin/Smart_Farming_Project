...
function smtp_mailer($to, $subject, $msg, $otp = null) {
    ...
    try {
        ...
        $mail->IsHTML(true);
        $mail->CharSet = 'UTF-8';
        $mail->Username = "sachinsinghey987@gmail.com";
        $mail->Password = "cwvjzumbeioycpgp";
        ...
        if ($email_sent) {
            ...
            if ($DEV_MODE && $otp) {
                header("location: fforgot_verify_otp.php?otp=" . $otp);
            } else {
            ...
            if ($DEV_MODE && $otp) {
                header("location: fforgot_verify_otp.php?email_error=1&otp=" . $otp);
            } else {
